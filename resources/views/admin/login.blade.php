...
<div class="min-h-[80vh] flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-8">
            <div class="w-16 h-16 rounded-2xl glow-gradient flex items-center justify-center mx-auto mb-4 pulse-glow">
        ...
        <!-- Card -->
        <div class="glass-dark rounded-2xl p-8" style="border: 1px solid rgba(217,70,239,0.2); box-shadow: 0 20px 60px rgba(217,70,239,0.1);">
