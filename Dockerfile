...
# Install system dependencies, PHP extensions (including gd, pdo_pgsql, pdo_mysql, pdo_sqlite), and Node.js
RUN apk add --no-cache \
    ...
    && docker-php-ext-install pdo pdo_sqlite pdo_mysql pdo_pgsql bcmath mbstring zip gd
